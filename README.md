...
`jin` を起動すると、ブラウザ用ダッシュボードが自動的に立ち上がります（既定: [http://localhost:3001](http://localhost:3001)）。各駒が**何を受け取り、どう動き、何をどこへ送ったのか**をリアルタイムに可視化します。
...
ポート3001が他のアプリと衝突する場合は環境変数で変更できます。
